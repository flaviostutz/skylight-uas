...
// **********************************************************************
// 
// $Source: /cvs/distapps/openmap/com/bbn/openmap/io/FileInputReader.java,v $
...
public class FileInputReader implements InputReader {
	...
	public FileInputReader(File f) throws IOException {
		logger.fine("FileInputReader created from " + f.getAbsolutePath());
		init(f);
	}
	...
	public FileInputReader(String f) throws IOException {
		logger.fine("FileInputReader created from " + f);
		init(new File(f));
	}
	...
	public void close() throws IOException {
		logger.fine("FileInputReader.close()");
		try {
			if (inputFile != null)
				inputFile.close();
		} catch (Exception e) {

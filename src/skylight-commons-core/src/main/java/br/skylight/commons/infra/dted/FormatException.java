...
// **********************************************************************
// 
// $Source: /cvs/distapps/openmap/com/bbn/openmap/io/FormatException.java,v $
// $RCSfile: FormatException.java,v $
// $Revision: 1.4 $
// $Date: 2002/05/22 22:20:10 $
// $Author: dietrick $
// 
// **********************************************************************
...
public class FormatException extends Exception {
	...
	/**
	 * Prints a backtrace of this exception and the rootCause (if any) to a
	 * stream.
	 * 
	 * @param ps
